...
$$
\sum^{n}_{i=1} (y_{i}-\bar{y}+\hat{\beta}_{1}\bar{x}-\beta_{1}x_{i})x_{i}=0
$$

Finalmente podemos despejar $\hat{\beta}_{1}$ de la siguiente manera:

$$
\sum^{n}_{i=1} (y_{i}-\bar{y})+\hat{\beta}_{1}\sum^{n}_{i=1} (\bar{x}-x_{i})=0
$$

$$
\hat{\beta}_{1}\sum^{n}_{i=1} (x_{i}-\bar{x})=\sum^{n}_{i=1} (y_{i}-\bar{y})
$$

$$
\hat{\beta}_{1}=\frac{\sum^{n}_{i=1}(y_{i}-\bar{y})}{\sum^{n}_{i=1}(x_{i}-\bar{x})}
$$
