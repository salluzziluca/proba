...
$$
\sum^{n}_{i=1} (y_{i-\frac{1}{n}}\sum^{n}_{j=1}(y_{j}-\hat{\beta}_{1}x_{j})-\beta_{1}x_{i})x_{i}
$$

$$
\sum^{n}_{i=1} (y_{i}-\frac{1}{n}\sum^{n}_{j=1}y_{j}+\frac{1}{n}\hat{\beta}_{1}\sum^{n}_{j=1}x_{j}-\beta_{1}x_{i})x_{i}
$$
...
$$
\sum^{n}_{i=1} (y_{i}-\bar{y}+\hat{\beta}_{1}\bar{x}-\beta_{1}x_{i})x_{i}
$$
